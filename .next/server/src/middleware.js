...
async function handleMiddleware(req, options, onSuccess) {
    ...
    const authPath = (0, _parseUrl.default)("http://localhost:3001").path;
    const publicPaths = [
        "/_next",
        "/favicon.ico"
    ];
