...
export default function FooterSection() {
    return (
        <footer className="border-t border-border/40 bg-zinc-950/20 py-16 backdrop-blur-md dark:bg-black/20">
            <div className="mx-auto max-w-5xl px-6">
                <Link
                    href="/"
                    aria-label="go home"
                    className="mx-auto block size-fit">
                    <span className="brand-gradient text-xl font-black tracking-wider uppercase">RankTime</span>
                </Link>
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} RankTime, All rights reserved</span>
            </div>
        </footer>
    )
}
